    ...
    switch ($_GET["action"]) {
        case "add":
            if (!empty($_POST["quantity"])) {
                ...
                if (!empty($cartResult)) {
                    // Maglumat bazasyndaky araba elementiniň mukdaryny täzeläň
...
<HEAD>
    <TITLE>PHP-de söwda arabasy</TITLE>
...
<BODY>
    ...
    <div id="shopping-cart">
        <div class="txt-heading">
            ...
            <a id="btnEmpty" href="index.php?action=empty"><img src="empty-cart.png" alt="empty-cart" title="Boş araba"
                    class="float-right" /></a>
            <div class="cart-status">
                <div>Jemi mukdar: <span id="total-quantity">
                        <?php echo $item_quantity; ?>
                    </span></div>
                <div>Jemi baha: <span id="total-price">
                        <?php echo $item_price; ?>
                    </span></div>
            </div>
        </div>
        ...
        if (!empty($cartItem)) {
            ...
            <div class="shopping-cart-table">
                <div class="cart-item-container header">
                    <div class="cart-info title">Ady:</div>
                    <div class="cart-info">Mukdary:</div>
                    <div class="cart-info price">Bahasy:</div>
                </div>
                    ...
                    <div class="cart-item-container">
                        ...
                        <div class="cart-info quantity">
                            <div class="btn-increment-decrement"
                                onClick="decrement_quantity(<?php echo $item["cart_id"]; ?>, '<?php echo $item["price"]; ?>')">-
                            </div><input class="input-quantity" id="input-quantity-<?php echo $item["cart_id"]; ?>"
                                value="<?php echo $item["quantity"]; ?>">
                            <div class="btn-increment-decrement"
                                onClick="increment_quantity(<?php echo $item["cart_id"]; ?>, '<?php echo $item["price"]; ?>')">+
                            </div>
                        </div>
                        ...
                        <div class="cart-info action">
                            <a href="index.php?action=remove&id=<?php echo $item["cart_id"]; ?>" class="btnRemoveAction"><img
                                    src="icon-delete.png" alt="icon-delete" title="Harydy aýyryň" /></a>
                        </div>
                    </div>
                    <?php
                }
